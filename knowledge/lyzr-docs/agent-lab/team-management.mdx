...
5. Whoever buys the plan becomes the Owner of the account, with all possible roles & permissions.
6. Owners cannot assign the Owner role to other members. If the Owner needs to be changed, please contact Lyzr support at [studio@lyzr.ai](mailto:studio@lyzr.ai).
