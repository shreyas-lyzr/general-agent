...
<Note>
  _Applicable to only paid users who are part of a plan._ 

  Visible to only Owner accounts, that have bought the plan

  _Users who did a top-up without purchasing a plan do not need to unsubscribe as top-up is a one-time payment and the credits do not have expiry_.
</Note>
